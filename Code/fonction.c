...
void accueil(){
        ...
        //
        couleurCourante(20, 20, 20);
        rectangle(3 * largeurFenetre() / 9, 5 * hauteurFenetre() / 25, 6* largeurFenetre() / 10, 6 * hauteurFenetre() /50);
        couleurCourante(255, 255, 0);
        epaisseurDeTrait(3);
        afficheChaine("Quitter", 40, 3* largeurFenetre() /9+15, 6* hauteurFenetre() /50+12);
}
